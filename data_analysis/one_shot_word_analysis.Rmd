...
```{r, echo=FALSE, message=F}
ggplot() +
  geom_bar(data=avg_skip_d, aes(x=num_train, y=nw_delta, fill=optimizing), stat="identity", position="dodge") +
#  geom_point(data=skip_d, aes(x=num_train,y=nw_delta, color=optimizing, group=interaction(approach, perm)), alpha=0.15) +
